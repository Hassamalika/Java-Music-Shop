...
public class NewStaff {
    ...
    public static String optionFive() {return "5 - Save changes";}
    ...
    public static void goToSelectedAction(int option, List<Product> list) {
        ...
        switch (option) {
            case 1 -> staffAddProduct(list);
            case 2 -> staffRemoveProduct(list);
            case 3 -> staffChangeStock(list);
            case 4 -> staffApplyDiscount(list);
            case 5 -> exit();
            default -> {
